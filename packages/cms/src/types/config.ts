...
export type AuthType = "anonymous" | "oauth2" | "apiKey" | "basic" | "bearer" | "custom";
...
export interface TcbProviderConfig {
  envId: string;
  region?: string;
  collections?: {
    schemas?: string;
...
export interface AlienCmsConfig {
  ...
  name: string;
  description?: string;
  provider?: "local" | "tcb" | "supabase" | "http";
  baseUrl?: string;
  auth?: AuthConfig;
  endpoints?: EndpointConfig;
  adapter?: AdapterConfig;
  schemaSource?: SchemaSourceConfig;
  tcb?: TcbProviderConfig;
