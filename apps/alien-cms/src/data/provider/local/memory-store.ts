...
declare global {
  var __alienCmsAppLocalMemoryStore__: LocalMemoryState | undefined;
}
...
function getState() {
  if (!globalThis.__alienCmsAppLocalMemoryStore__) {
    globalThis.__alienCmsAppLocalMemoryStore__ = createState();
  }
  return globalThis.__alienCmsAppLocalMemoryStore__;
}
