...
const MAX_LOGS = 500;
declare global {
  var __alienCmsAppLocalLogs__: LogEntry[] | undefined;
}

function getStore() {
  if (!globalThis.__alienCmsAppLocalLogs__) {
    globalThis.__alienCmsAppLocalLogs__ = [];
  }
  return globalThis.__alienCmsAppLocalLogs__;
}
