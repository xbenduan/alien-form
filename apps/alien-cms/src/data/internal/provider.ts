...
import type { LogProvider } from '../provider/log-provider';
...
let logProvider: LogProvider | null = null;
...
export function getLogProvider(): LogProvider {
  if (!logProvider) {
    throw new Error('[alien-cms/data] Provider not initialized. Call initProvider() at app startup.');
  }
  return logProvider;
}
