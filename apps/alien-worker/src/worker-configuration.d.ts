/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=../../wrangler.json src/worker-configuration.d.ts` (hash: 9c791ca59ac8911a6acea3babf97c9ba)
// Runtime types generated with workerd@1.20260826.1 2026-09-08 nodejs_compat
